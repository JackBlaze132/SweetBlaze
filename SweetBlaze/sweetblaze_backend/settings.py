"""
Django settings for sweetblaze_backend project.
...
SECRET_KEY = 'django-insecure-=!l*9^kzz$jzso2!t8!!*20*zn10cg1-lo8a^wqg=)e1qh)5ir'
...
ROOT_URLCONF = 'sweetblaze_backend.urls'
...
WSGI_APPLICATION = 'sweetblaze_backend.wsgi.application'
